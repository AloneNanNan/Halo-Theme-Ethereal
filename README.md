...
一款基于[halo-theme-fuwari](https://github.com/jiewenhuang/halo-theme-fuwari)二次开发

为 [Halo 2.x](https://github.com/halo-dev/halo) 打造的现代博客主题
...
<p align="center">
  ...
  <a href="https://github.com/AloneNanNan/halo-theme-ethereal/releases" target="_blank">
    <img src="https://img.shields.io/github/v/release/AloneNanNan/halo-theme-ethereal?color=8B5CF6&label=Release" alt="Release"/>
  </a>
  <a href="https://github.com/AloneNanNan/halo-theme-ethereal/blob/main/LICENSE" target="_blank">
...
<table align="center">
  <tr>
    ...
    <td align="center"><b>🔗 友链</b></td>
    <td align="center"><b>👥 朋友圈</b></td>
    <td align="center"><b>💻 装备</b></td>
    <td align="center"><b>📸 瞬间</b></td>
  </tr>
  <tr>
    <td><img src="./screenshot/home.png" alt="首页" width="160" /></td>
    <td><img src="./screenshot/links.png" alt="友情链接" width="160" /></td>
    <td><img src="./screenshot/friends.png" alt="朋友圈" width="160" /></td>
    <td><img src="./screenshot/equipments.png" alt="装备" width="160" /></td>
    <td><img src="./screenshot/moments.png" alt="瞬间" width="160" /></td>
  </tr>
</table>
...
| 音乐播放器 | [Meting API](https://api.i-meto.com/meting/api) | 默认使用 MetingJS 公共 API 获取网易云/QQ/酷狗等平台的歌单歌曲数据，支持在设置中替换为自建 API                                |
| 一言小组件 | [一言 API](https://v1.hitokoto.cn)              | 随机获取一句名言短句，无需 API Key，支持 5 秒超时和本地 fallback                                                             |
