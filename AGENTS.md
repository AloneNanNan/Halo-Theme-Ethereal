...
Halo 2 CMS blog theme "Ethereal" - an Astro-based theme originally based on [fuwari](https://github.com/saicaca/fuwari).

**Tech Stack**: Astro 6, Svelte 5, Tailwind CSS 4, TypeScript, pnpm
...
- Base path: `/themes/theme-ethereal`
...
- `templates/` and `_ethereal/` are gitignored - don't edit build output
- `_ethereal/` contains the original ethereal theme source for reference
